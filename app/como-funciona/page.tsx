      ...
      <main className={styles.page}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroTop}>
            <span className={styles.eyebrow}>NUESTRO PROCESO</span>

            <span className={styles.heroIndex}>VALTARA / 01</span>
          </div>
        ...
        <section className={styles.process}>
          <div className={styles.processHeader}>
            <div>
              <span className={styles.sectionLabel}>EL PROCESO</span>
        ...
        <section className={styles.explanation}>
          ...
          <div className={styles.explanationBody}>
            ...
            <p>
              ...
              reconocer los elementos relevantes y tener una visión más clara
        ...
        <section className={styles.principles}>
          <div className={styles.principlesIntro}>
            <span className={styles.sectionLabel}>NUESTRO ENFOQUE</span>
        ...
        <div className={styles.footerSpace}>
          <span>VALTARA · Resguardo y Recuperación Patrimonial</span>
        </div>
      </main>
    </>
  );
